...
<html lang="en">
    <head>
        <title>{{ $title ?? 'Moslem Clothes' }}</title>
        <!-- Required meta tags -->
        <!-- CSRF Token -->
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="Moslem Clothes Menjual berbagai macam hijab, jaket, aksesoris dan pakaian islami pria dan wanita" name="description">
        <meta content="{{ $title ?? 'Moslem Clothes' }}" name="keywords">
